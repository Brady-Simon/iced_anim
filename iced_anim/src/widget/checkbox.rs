//! An animated checkbox that lets a user toggle some value.
...
use iced::{
    ...
    Background, Border, Color, Element, Length, Pixels, Rectangle, Size, Theme,
};

/// An animated box that can be checked.
